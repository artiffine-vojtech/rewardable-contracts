...
export interface RewardDistributorV1Interface extends utils.Interface {
  functions: {
...
export interface RewardDistributorV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardDistributorV1Interface;
