...
export interface ITokenEmissionsControllerInterface extends utils.Interface {
  functions: {
...
export interface ITokenEmissionsController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITokenEmissionsControllerInterface;
